window.onload = function() {
    const videoFile = sessionStorage.getItem('focusedVideoData.link') || 'URL_VIDEO_ANDA_DI_SINI.mp4';
    const textFile = sessionStorage.getItem('focusedVideoData.title') || "Default Title";
